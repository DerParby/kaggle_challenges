...
# Load the data.
train_df = pd.read_csv("/workspaces/ml_challenge/data/train.csv")
test_df = pd.read_csv("/workspaces/ml_challenge/data/test.csv")
...
pred_df.to_csv('/workspaces/ml_challenge/data/output.csv', header=True, index_label='Id')